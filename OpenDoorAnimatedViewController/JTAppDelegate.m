...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.targetController = [[UIViewController alloc] init];
    self.targetController.view.backgroundColor = [UIColor colorWithRed:0.534 green:1.000 blue:0.880 alpha:1.000];
...
#pragma mark - OpenDoorDelegate
- (void)didFinishAnimation
{
    self.window.rootViewController = self.targetController;
}
